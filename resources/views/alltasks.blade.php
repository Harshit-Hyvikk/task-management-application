    ...
    <main>
        <div class="container">
            <div class="container mt-3">
                <h4>
                    <i class="fas fa-tasks "></i> Task Category
                </h4>
                <div class=" my-2  d-sm-flex flex-wrap gap-4 ">
                    @foreach ($categories as $cat)
                        <div class="col-md-3 col-sm-5 col-12 mt-2">
                            <div class="card  border-success">
                                <div class="card-body d-flex  justify-content-between">
                                    <div>
                                        <h5 class="card-title mb-0 fs-5 ">{{ $cat->name }}</h5>
            ...
            <div class="row align-middle">
                <div class="col-10 mt-2">
                    <h3 class="my-2"><i class="fas fa-tasks"></i> Tasks</h3>
                </div>
                <div class="col-2 d-flex gap-2">
                    <a href="{{ route('alltasks.create') }}" class="btn btn-info my-3">Add New Tasks</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($tasks as $task)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('alltasks.show', $task->id) }}"
                                            class="btn btn-primary btn-sm ">View</a>
                                        <a href="{{ route('alltasks.edit', $task->id) }}"
                                            class="btn btn-success btn-sm my-1">Update</a>
